...
def weighted_img(img, initial_img, alpha=0.8, betta=1., gamma=0.):
	"""
	...
	return cv2.addWeighted(initial_img, alpha, img, betta, gamma)
...
def color_frame_pipeline(frames, solid_lines=True, temporal_smoothing=True):
	...
	img_blend = weighted_img(img_masked, img_color, alpha=0.8, betta=1., gamma=0.)
